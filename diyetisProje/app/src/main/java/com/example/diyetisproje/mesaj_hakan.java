...
public class mesaj_hakan extends AppCompatActivity {
    ScrollView myscroll;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mesaj_hakan);
        ...
        onlineKullanici= FirebaseDatabase.getInstance().getReference().child("Mesaj").child("Hakan").child("ad");
        ...
        mesajAdi= FirebaseDatabase.getInstance().getReference().child("Mesaj").child("Hakan");
