...
public class mesaj_sinem extends AppCompatActivity {
    ScrollView myscroll;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mesaj_sinem);
        ...
        onlineKullanici= FirebaseDatabase.getInstance().getReference().child("Mesaj").child("Sinem").child("ad");
        ...
        mesajAdi= FirebaseDatabase.getInstance().getReference().child("Mesaj").child("Sinem");
