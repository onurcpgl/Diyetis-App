...
public class mesaj_orkun extends AppCompatActivity {
    ScrollView myscroll;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mesaj_orkun);
        ...
        onlineKullanici=FirebaseDatabase.getInstance().getReference().child("Mesaj").child("Orkun").child("ad");
        ...
        mesajAdi= FirebaseDatabase.getInstance().getReference().child("Mesaj").child("Orkun");
