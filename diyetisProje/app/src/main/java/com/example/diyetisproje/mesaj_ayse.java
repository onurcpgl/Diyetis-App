...
public class mesaj_ayse extends AppCompatActivity {
    ScrollView myscroll;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mesaj_ayse);
        ...
        onlineKullanici= FirebaseDatabase.getInstance().getReference().child("Mesaj").child("Ayşe").child("ad");
        ...
        mesajAdi= FirebaseDatabase.getInstance().getReference().child("Mesaj").child("Ayşe");
